 ...
 * 
 * GeaVR is an open source software that allows the user to experience a wide range 
 * of geological and geomorphological sites in virtual reality.
 *
 * Main Developers:      
 * 
 ...
 *     Cometa Consortium for the experimentation of cutting-edge interactive technologies
 *     for the improvement of science teaching and dissemination” of 
 *     Italian Ministry of Education, University and Research (ARGO3D)
 *     PI: Alessandro Tibaldi (alessandro.tibaldi@unimib.it)
 *     
 *     Erasmus+ Key Action 2 2017-1-UK01-KA203- 036719 “3DTeLC – Bringing the 3D-world 
 *     into the classroom: a new approach to Teaching, Learning and Communicating the 
